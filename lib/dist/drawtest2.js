import { besideD, centerBesideD, centerOverD, justBesideD, lineD, overD, padD, scaleD, textD, translateD, justOverD, transformD, draw, drawables, } from "./draw/draw4.js";
import { isConvexShapesIntersecting } from "./math/collision.js";
import { id, } from "./math/CtxTransform.js";
...
const frac = (slot1, slot2) => centerOverD(smallPad(slot1), overD(lx, smallPad(slot2)));
...
const box = (slot) => drawables(scaleD([slot.w + 10, slot.h + 10])(rect), padD([5, 5])(slot));
...
function anim() {
    ...
    canvasRender(justOverD(padD([0, 120])(justBesideD(goldenRatio, transformD(id)(φ))), centerBesideD(tD("ζ(s)﹦"), ΣNote, tD("﹦"), box(Π(tD("∞"), tD("p∊ℙ"), frac(tD("1"), centerBesideD(tD("1−"), exp(tD("p"), tD("−s")))))))));
