export class EditorElement extends HTMLElement {
    ...
    constructor({ parentEditor, builder } = {
        ...
        butEl.addEventListener("click", async () => {
            const [{ ConstructiveUnidirectionalEditor }, { TextEditorElement }] = await Promise.all([
            ...
            const LiftedEval = ConstructiveUnidirectionalEditor({
                leftEditorFactory: (a, me) => new TextEditorElement({ parentEditor: me, code: [this] }),
        ...
        setTimeout(() => ((paletteEl.innerText = this.meta?.editorName ?? "editor"),
