...
import { EditorElement, enterEditorDirection, exitEditorDirection, } from "../editor.js";
    ...
    moveCaret(change, isSelecting) {
        ...
        if (isSelecting) {
            ...
            if (this.caret < newCaret) {
                ...
                this.onCaretMoveOverContentItem(this.contents.slice(newCaret, this.caret));
            }
            this.caret = newCaret;
