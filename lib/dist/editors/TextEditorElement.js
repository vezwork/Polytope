    ...
    constructor({ code, builder } = {}) {
        ...
        this.addEventListener("keydown", (e) => {
            ...
            if (this.isCaretInSlot) {
                ...
                this.codeEl.innerHTML = "";
                this.codeEl.append(...this.displayHTML());
                (_b = this.parentEditor) === null || _b === void 0 ? void 0 : _b.dispatchEvent(new CustomEvent("childEditorUpdate", {
                    detail: {
                        out: this.getOutput(),
                        editor: this,
                    },
                ...
                (_c = this.parentEditor) === null || _c === void 0 ? void 0 : _c.dispatchEvent(new CustomEvent("childEditorUpdate", {
                    detail: {
                        out: this.getOutput(),
                        editor: this,
                    },
                ...
                //    focuser.focus();
                //}
                (_d = this.parentEditor) === null || _d === void 0 ? void 0 : _d.dispatchEvent(new CustomEvent("childEditorUpdate", {
                    detail: {
                        out: this.getOutput(),
                        editor: this,
                    },
