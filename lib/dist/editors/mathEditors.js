    ...
    class C extends EditorElement {
        ...
        constructor(arg) {
            ...
            this.addEventListener("childEditorUpdate", (e) => {
                this.parentEditor?.dispatchEvent(new CustomEvent("childEditorUpdate", { detail: this.getOutput() }));
            });
        }
...
export const DivJoinerElement = BinaryJoinerElement("div", MathEditorElement, MathEditorElement, (leftEditor, rightEditor) => {
...
export const Vec2JoinerElement = BinaryJoinerElement("vec2", MathEditorElement, MathEditorElement, (leftEditor, rightEditor) => {
    const styleEl = document.createElement("style");
    styleEl.textContent = `
            :host {
                display: inline-flex;
...
export const MatrixJoinerElement = GridJoinerElement("matrix", (editor2DArray) => {
    const styleEl = document.createElement("style");
    styleEl.textContent = `
            :host {
                display: inline-flex;
...
export const ConstructBinarySymbolJoinerElement = (outputFuncName, LeftEditor, symbol, RightEditor) => BinaryJoinerElement(outputFuncName, LeftEditor, RightEditor, (leftEditor, rightEditor) => {
    const plusEl = document.createElement("span");
    plusEl.textContent = symbol;
    return [leftEditor, plusEl, rightEditor];
});
export const ConstructExpJoinerElement = (outputFuncName, LeftEditor, RightEditor) => BinaryJoinerElement(outputFuncName, LeftEditor, RightEditor, (leftEditor, rightEditor) => {
    const styleEl = document.createElement("style");
    styleEl.textContent = `
            :host {
                display: inline-flex;
...
export const RadicalJoinerElement = UnaryJoinerElement("sqrt", MathEditorElement, (editor) => {
    const styleEl = document.createElement("style");
    styleEl.textContent = `
            :host {
                display: inline-flex;
