...
import { add, mul, sub, dot } from "./Vec2.js";
 ...
 *
 */
export const reverseLerp = ([start, end]) => (p) => dot(sub(p, start), sub(end, start));
export const segProj = (seg) => (p) => {
...
export const reverse = ([p1, p2]) => [p2, p1];
