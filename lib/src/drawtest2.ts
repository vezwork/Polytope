import { best, worst } from "./Arrays.js";
import { makeCaretFunctions } from "./caret.js";
import { YInterval } from "./caretNav.js";
import {
  besideD,
  centerBesideD,
  centerOverD,
...
import { add, distance, rotate, setLength, sub, Vec2 } from "./math/Vec2.js";
...
const main = editor(
  drawables(
    justOverD(
      ...
      padD([10, 20])(
        justOverD(
          citeImage("./pres2/cellpond.png", "Cellpond", 900, "Lu Wilson"),
          citeImage("./pres2/scratch.png", "Scratch Blocks", 700),
          citeImage(
            "./pres2/livelits.png",
          ...
          citeImage("./pres2/mps.png", "jetbrains.com/mps/", 150),
          citeImage("./pres2/code.png", "Traditional Code Editor", 0)
        )
      ),
      padD([0, 170])(scaleD([300, 2])(lx)),
      centerBesideD(
        translateD([0, 220])(editor(justOverD(tD("Text"), tD("Programming")))),
        newImage("./pres2/bridge.svg", 682, 420),
